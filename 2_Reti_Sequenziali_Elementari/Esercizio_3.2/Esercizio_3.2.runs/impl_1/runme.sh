...
HD_PWD='C:/Users/alfonsomoggio/Desktop/Elaborato_ASDI/2_Reti_Sequenziali_Elementari/Esercizio_3.2/Esercizio_3.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_ric.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_ric.tcl -notrace
