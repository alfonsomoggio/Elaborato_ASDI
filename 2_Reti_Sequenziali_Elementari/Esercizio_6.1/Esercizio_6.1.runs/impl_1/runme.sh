...
HD_PWD='C:/Users/alfonsomoggio/Desktop/Elaborato_ASDI/2_Reti_Sequenziali_Elementari/Esercizio_6.1/Esercizio_6.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_PO_PC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_PO_PC.tcl -notrace
