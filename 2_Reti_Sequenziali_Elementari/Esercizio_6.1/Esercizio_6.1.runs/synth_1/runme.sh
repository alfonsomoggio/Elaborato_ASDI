...
HD_PWD='C:/Users/alfonsomoggio/Desktop/Elaborato_ASDI/2_Reti_Sequenziali_Elementari/Esercizio_6.1/Esercizio_6.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_PO_PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_PO_PC.tcl
