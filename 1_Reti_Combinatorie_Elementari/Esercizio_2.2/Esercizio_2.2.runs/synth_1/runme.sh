...
HD_PWD='C:/Users/alfonsomoggio/Desktop/Elaborato_ASDI/1_Reti_Combinatorie_Elementari/Esercizio_2.2/Esercizio_2.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_S.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sistema_S.tcl
