...
HD_PWD='C:/Users/alfonsomoggio/Desktop/Elaborato_ASDI/1_Reti_Combinatorie_Elementari/Esercizio_2.2/Esercizio_2.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_S.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sistema_S.tcl -notrace
